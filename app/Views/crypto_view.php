...
<body>
    ...
    <script>
        ...
        //Permite agregar o quitar favoritos desde el botón de estrella.
        ...
        //Llama al backend (data()) cada 30 segundos para obtener los datos actualizados.
        //Renderiza la tabla y actualiza las flechas de subidas/bajadas.
        ...
        //Genera el HTML dinámico para la tabla.
        //Resalta criptos favoritas, muestra íconos y flechas de tendencia 🔼🔽.
    ...
    `;
        ...
        //Permite seleccionar una criptomoneda específica y ver solo su gráfico y datos.
        ...
        //Restaura la tabla completa cuando el usuario quiere salir de la vista filtrada.
        ...
        //Llama al backend (historicalData) para obtener los precios históricos.
        //Muestra un gráfico de línea con tendencia usando Chart.js + plugin trendline.
        //Soporta filtro por fechas (inicio/fin).
        function generateChart() {
            ...
            // Usar 'let' en vez de 'const' para evitar redeclarar la variable 'url(codeingniter)'
        ...
        //Permite buscar criptomonedas por nombre.
        //Si no encuentra coincidencias, muestra un mensaje de error debajo de la tabla.
